...
import AboutImg from '../../assets/images/resources/aboutprofile(1).png';
    ...
    >
      ...
      <div className='container sm:container md:container lg:container xl:container 2xl:container mx-auto'>
        <SectionTitle
          title='About'
          titleInner='Me'
          desc='Driven by creativity and a love for problem-solving, I thrive in collaborative environments where innovation and teamwork intersect.'
        ></SectionTitle>
...
const AboutUs = (props) => {
  return (
    <section id="about" className="aboutUsWrap py-[4.5rem] md:py-[5.5rem] lg:py-[6.5rem] xl:py-[7.5rem] relative w-full">
      <div
        className="fixedBg bg-left-top bg-no-repeat opacity-20"
        // style={{ backgroundImage: `url(${PatternImg})` }}
      ></div>
