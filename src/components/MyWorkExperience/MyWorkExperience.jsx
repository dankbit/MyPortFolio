...
import SectionBg from "../../assets/images/workexpback.jpg";
...
const MyWorkExperience = () => {
  return (
    <section id="experience" className="workExpWrap py-[4.5rem] md:py-[5.5rem] lg:py-[6.5rem] xl:py-[7.5rem relative w-full">
      ...
      <div className="container sm:container md:container lg:container xl:max-w-[86.875rem] mx-auto">
        <SectionTitleLight
          ...
          desc="Accomplished  Web Designer with a proven track record in crafting dynamic, responsive websites that enhance user experience and meet diverse client requirements."
        ></SectionTitleLight>
