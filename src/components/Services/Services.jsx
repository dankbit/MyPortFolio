...
const Services = () => {
  return (
    <section id="services" className="servicesWrap mb-14 pb-[4.5rem] md:pb-[5.5rem] lg:pb-[6.5rem] xl:pb-[7.5rem] relative w-full">
      <div className="container sm:container md:container lg:container xl:max-w-[98.125rem] mx-auto">
        <SectionTitle
          title="The Best"
          titleInner="Services"
          subTitle="What We Do"
          desc="Offering bespoke web design and development services, tailored to enhance user experience and elevate your online presence."
        ></SectionTitle>
